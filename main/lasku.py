...
class GenerateInvoice(FPDF):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.delivery_way = kwargs.get('delivery_way', 'Error')
        super().__init__()

    def header(self):
        self.image('static_style/img/Untitled.png', 10, 8, 25)
...
def create_invoice(**kwargs):
    ...
    pdf.cell(0, 5, f'ATTN:{pdf.name}', ln=1)
    ...
    pdf.cell(20, 5, '0', border=1, ln=1, align='C', fill=1)
    pdf.set_x(20)
    pdf.set_font('courier', 'B', 10)
    pdf.cell(150, 8, 'Yhteensä', border=1, fill=1)
    pdf.cell(20, 8, f'{pdf.totel}0', border=1, ln=1, align='C', fill=1)
    pdf.ln()
    pdf.ln()
